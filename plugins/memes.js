...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'meme ?(.*)', fromMe: false, desc: Lang.MEMES_DESC}, (async (message, match) => {    
	    ...
	    memeMaker({
            ...
            if(err) throw new Error(err)
            await message.client.sendMessage(message.jid, fs.readFileSync('asena-meme.png'), MessageType.image, {filename: 'Jenifer-meme.png', mimetype: Mimetype.png, caption: 'Made by WhatsAsena'});
            await info.delete();    
        });
    }));
}
